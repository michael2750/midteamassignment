...
public class RecognitionAllIT {
    ...
    public RecognitionAllIT(String image, String plate){
        this.snapshot = image;
        this.expectedPlate = plate;
    }
    ...
    @Test
    public void IntelligenceAll() throws Exception {
    ...
    @Test
    public void IntelligenceAllITWithHamcrest() throws Exception {
        final String image = snapshot;
        CarSnapshot carSnap = new CarSnapshot("snapshots/" + image);
